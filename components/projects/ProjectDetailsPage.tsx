...
export type ProjectDetailsData = {
  ...
  layoutsEyebrow: string;
  layoutsTitle: string;
  layoutsDescription: string;
  unitConfigDescription: string;
  ...
  unitSizes: readonly string[];
  facings: readonly string[];
  amenities: readonly string[];
  /** Optional image-backed amenities gallery. Falls back to text cards when empty. */
  amenityGallery?: readonly AmenityGalleryItem[];
  layoutGroups: readonly {
    title: string;
    plans: readonly {
      id: string;
      label: string;
...
export function ProjectDetailsPage({
  ...
  const siteVisitMessage = [
    ...
    "",
    `Site Visit Request — ${project.name}`,
    "",
    `I would like to book a site visit for ${project.name}.`,
    ...
    <>
              ...
              <div className="mt-8 flex flex-col gap-3 sm:flex-row sm:flex-wrap">
                ...
                <Button
                  href={buildWhatsAppUrl(
                    `Hello Done & Delivered,\n\nI would like more details on ${project.name}.`,
                  )}
                  target="_blank"
                  rel="noopener noreferrer"
                  variant="ghost"
      ...
      <section className="relative section-pad section-soft overflow-hidden">
        <Container>
          <SectionHeading
            ...
            description={project.masterPlanDescription}
          />
          <Reveal>
            <button
              type="button"
      ...
      <section className="relative section-pad overflow-hidden bg-white">
        <Container>
          <SectionHeading
            eyebrow="Amenities"
            title={project.amenitiesTitle}
            description={project.amenitiesDescription}
          />
      ...
      <section className="relative section-pad section-soft overflow-hidden">
        <Container>
          <SectionHeading
            eyebrow={project.layoutsEyebrow}
            title={project.layoutsTitle}
            description={project.layoutsDescription}
          />
      ...
      <section className="relative section-pad overflow-hidden bg-white">
        <Container>
          <SectionHeading
            ...
            description={project.unitConfigDescription}
          />
        ...
        <Container>
          ...
          <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-3">
            {project.gallery.map((item, index) => (
              <Reveal key={item.src + item.alt} delay={(index % 6) * 0.04}>
                <button
                  type="button"
                  onClick={() =>
          ...
          <div className="grid gap-8 lg:grid-cols-[0.9fr_1.1fr] lg:items-start">
            <div>
              <SectionHeading
                ...
                className="mb-0"
                eyebrow="Enquiry"
                title={project.enquiryTitle}
                description={project.enquiryDescription}
              />
